...
class ShoppingCart
{
    ...
    public function __construct(SessionInterface $sessionInter, EntityManagerInterface $em, SubscriptionHelper $subscriptionHelper)
    {
    ...
    {
        $planId = $this->sessionInter->get(self::CART_PLAN_KEY);
    ...
    {
        return $this->sessionInter->get(self::CART_COUPON_CODE_KEY);
    }

    public function getCouponCodeValue()
    {
        return $this->sessionInter->get(self::CART_COUPON_VALUE_KEY);
    }
    ...
    {
        $this->sessionInter->set(self::CART_PLAN_KEY, $planId);
    }
}